...
->To install the above mentioned packages and modules, you can execute the following command. 
...
2) requirements.txt - includes the packages and modules required and their versions.
